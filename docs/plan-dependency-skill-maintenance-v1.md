...
- [ ] **Task 1: Smoke-test `dependency_health.sh` (report mode)**
...
- [ ] **Task 2: Smoke-test `dependency_health.sh --full` (advisory scan)**
...
- [ ] **Task 3: Smoke-test `regenerate_skills.sh` (check mode)**
...
- [ ] **Task 4: Run `regenerate_skills.sh --write`**
...
- [ ] **Task 5: Run `--auto` to apply safe upgrades**
...
- [ ] **Task 7: Fetch `share_plus` changelog for 10.1.4 → 13.0.0**
...
- [ ] **Task 8: Assess other major bumps (`vector_math`, `meta`, `test`, `dart_style`)**
...
- [ ] **Task 9: Validate the workflow YAML syntax**
...
- [ ] **Task 10: Push and confirm CI job appears in GitHub Actions**
...
- [ ] **Task 11: Verify `copilot-instructions.md` section is correct**
