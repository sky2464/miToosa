...
Review the implementation against: the active spec's acceptance criteria (all AC-NNN must-priorities), the Linear charter for this story, user-facing completeness, and business value delivery. Flag any AC not implemented as 🔴 Critical. Report as 🔴 Critical / 🟡 Warning / 🟢 Passed.
...
4. Update Docs/Master-Plan.md and Linear with review status.
