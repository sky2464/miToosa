  ...
  group('HeartsBar', () {
    testWidgets('shows 5 filled hearts at full', (tester) async {
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 5, diamonds: 0),
      ));
    ...
    testWidgets('shows 2 filled + 3 empty hearts', (tester) async {
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 2, diamonds: 0),
      ));
    ...
    testWidgets('shows diamond count', (tester) async {
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 5, diamonds: 3),
      ));
    ...
    testWidgets('refuel button hidden when hearts == 5', (tester) async {
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 5, diamonds: 2),
      ));
    ...
    testWidgets(
        'refuel button visible when hearts < 5 AND diamonds >= 1', (tester) async {
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 3, diamonds: 1),
      ));
    ...
    testWidgets('renders without overflow at 320px width', (tester) async {
      ...
      await tester.pumpWidget(_wrap(
        const HeartsBar(hearts: 3, diamonds: 2),
      ));
