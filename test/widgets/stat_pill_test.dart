  ...
  group('StatPill', () {
    ...
    testWidgets('renders icon when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(const StatPill(icon: Icon(Icons.bolt), label: 'test')),
      );
    ...
    testWidgets('orange tint uses AP.orange', (tester) async {
      await tester.pumpWidget(
        _wrap(const StatPill(label: 'streak', tint: StatPillTint.orange)),
      );
    ...
    testWidgets('glow adds outer shadow', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const StatPill(label: 'test', tint: StatPillTint.amber, glow: true),
        ),
      );
      final container = tester.widget<Container>(
        find
